...
jq -e '.schema=="gooo/semantic-wave-merge-projector/wave-projection/v1" and .scenario_denominator==12 and .state_counts=={total:12,closed:4,unknown:4,refuted:4} and .cases[0].case_id=="independent-merge" and .cases[0].state=="CLOSED" and .cases[0].accepted_wave==["proposal-cell-68","proposal-cell-69","proposal-cell-70","proposal-cell-71"] and .cases[0].deferred_frontier==[] and .cases[0].conflict_witnesses==[]' "$wave_product/actual/wave-projection.json" >/dev/null
