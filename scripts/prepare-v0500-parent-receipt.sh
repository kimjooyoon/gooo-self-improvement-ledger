...
jq -S -n \
  ...
  --argjson release "$parent_release" --argjson ref "$parent_ref" --argjson tag_record "$parent_tag_record" --argjson artifact "$parent_artifact" --argjson run "$parent_run" --argjson job "$parent_job" --argjson contents "$parent_contents" \
  --argjson asset "$release_asset" --arg public_refs "$public_refs" \
