...
if [ "$mode" = --repository ]; then
  ...
  jq -e '
    ...
    .parent_preservation.release_id==380866481 and .parent_preservation.tag=="v0.50.0" and .parent_preservation.tag_object_sha=="9e3263ea902bef64fa31c05ca7c1ab038ef962ef" and .parent_preservation.target_commit_sha=="e93768f4204e8a88214026ffa22febad7ecedcbd" and .parent_preservation.parent_lock_count==59 and .parent_preservation.primary_reused==59 and .parent_preservation.changed_selected==3 and .parent_preservation.changed_executed==3 and .parent_preservation.full_62_lock_audit_executed==false and
