...
language. The denominator is exactly 46 named cells, each bound one-to-one to
...
`DIFFERENTIAL_SEMANTICS_RUNTIME_DURABLE_RELEASE`.

The denominator migration is explicit and append-only: `45 -> 46` with
`ADD1/RETIRE0/SPLIT0`. The proof buckets are `FOUNDATION/COHERENCE/REGRESSION`
`4/37/5`, and the indicator buckets are `DRIVER/OUTCOME/GUARDRAIL` `4/37/5`.
...
commit, and consumer asset identities for the forty-three immutable inputs
